...
CREATE POLICY "Enable all operations for all users" ON campaigns FOR ALL USING (true);
CREATE POLICY "Enable all operations for all users" ON content_items FOR ALL USING (true);
CREATE POLICY "Enable all operations for all users" ON scheduled_posts FOR ALL USING (true);
